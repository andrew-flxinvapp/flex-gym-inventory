                ...
                Column(
                  ...
                  children: [
                    ...
                    DeleteAccountSelector(
                      selected: false,
                      text: 'I am no longer using the app',
                    ),
                    DeleteAccountSelector(
                      selected: false,
                      text: 'I\'m switching to a different tool',
                    ),
                    DeleteAccountSelector(
                      selected: false,
                      text: 'It\'s missing features I need',
                    ),
                    DeleteAccountSelector(
                      selected: false,
                      text: 'I found it hard to use',
                    ),
                    DeleteAccountSelector(
                      selected: false,
                      text: 'I am concerned about my privacy or data',
                    ),
                    DeleteAccountSelector(
                      selected: false,
                      text: 'I only needed it temporarily',
                    ),
                    DeleteAccountSelector(
                      selected: false,
                      text: 'Other (please specifiy below)',
                    ),
